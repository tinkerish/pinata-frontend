...
const Feature = () => {
  ...
  return (
    <div className="relative py-36 text-center feature-content-irregular-shape mt-[9rem]">
      <div className="feature-irregular-shape flex flex-wrap justify-between overflow-hidden p-12 absolute w-full h-full top-0 left-0">
      ...
      <div className=" relative max-w-[80%] mx-auto text-[#3f9097]">
